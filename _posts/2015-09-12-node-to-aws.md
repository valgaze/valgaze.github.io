...
#[AWS] Deploy Your Damn Nodejs to Amazon Web Services

Warning...

**You should read this if:** You have built a nodejs application as a side/educational project and want to deploy it in the wild. Hopefully you’ve never touched AWS before and are curious about it.
...
With that out of the way, let's discuss the state of play: These days if you have a Nodejs application and want to get it deployed , you have lots of choices--Heroku, Nodejitsu, Digital Ocean, Appfrog, Azure, and a whole host of others. Different providers compete on price, functionality, workflows, ease-of-use, security, control, and many other factors. For someone just looking to deploy their app to a reliable and competent provider, the sheer volume of choices can be a bit overwhelming. To simplify things this is the first in a series of step-by-step instructions of exactly how to deploy your site to nodejs and sidestep many potential problems.

At the bottom of this post are a ton of links/resources on AWS and other sources for hosting your node app
...
**DIRECT LINK:** **<u>[https://us-west-2.console.aws.<wbr>amazon.com/elasticbeanstalk/<wbr>home?region=us-west-2](https://us-west-2.console.aws.amazon.com/elasticbeanstalk/home?region=us-west-2)</u>**
...
12.  On the “Application Version” page, select the “Upload your option” and upload the zipped version of your nodejs application from Step #8 then click **NEXT** (you’ll need a wait a bit while it uploads)
...
* Node on Heroku: https://adamhedge.azurewebsites.net/2015/09/09/really-deploying-your-node-server-on-heroku/

*   [https://seroter.wordpress.com/<wbr>2013/07/29/where-the-heck-do-<wbr>i-host-my-node-js-app/](https://seroter.wordpress.com/2013/07/29/where-the-heck-do-i-host-my-node-js-app/)
*   [http://docs.aws.amazon.com/<wbr>gettingstarted/latest/deploy/<wbr>overview.html](http://docs.aws.amazon.com/gettingstarted/latest/deploy/overview.html)

*   [http://docs.aws.amazon.com/<wbr>gettingstarted/latest/deploy/<wbr>setting-up.html#download-app](http://docs.aws.amazon.com/gettingstarted/latest/deploy/setting-up.html#download-app)
